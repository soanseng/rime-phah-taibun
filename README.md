...
[![Lua Modules](https://img.shields.io/badge/lua-15%20modules-orange?style=flat-square)](#)
...
| `Tab` | 選字模式 / 音節跳轉 | 候選出現時：進入選字模式（asdf/數字鍵選字）；否則：跳到下一個音節 |
...
lua/                           Lua 擴充模組（15 個）
  ...
  phah_taibun_data.lua            漢羅規則載入器 + 聲調調符轉換 + 共用工具
